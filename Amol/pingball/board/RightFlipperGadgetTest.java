...
import physics.Vect;
import pingball.board.RightFlipperGadget.FlipperOrientation;
...
public class RightFlipperGadgetTest {
    ...
    public void testRenderHorizontalNWCorner() {
        RightFlipperGadget gadget = new RightFlipperGadget("test", new Vect(0, 0), VertexOrientation.NW);
    ...
    public void testRenderHorizontalNECorner() {
        RightFlipperGadget gadget = new RightFlipperGadget("test", new Vect(18, 0), VertexOrientation.NW);
        String renderedString = gadget.render(emptyBoardString);
    ...
    public void testRenderHorizontalSWCorner() {
        RightFlipperGadget gadget = new RightFlipperGadget("test", new Vect(0, 19), VertexOrientation.NW);
        String renderedString = gadget.render(emptyBoardString);
    ...
    public void testRenderHorizontalSECorner() {
        RightFlipperGadget gadget = new RightFlipperGadget("test", new Vect(18, 19), VertexOrientation.NW);
        String renderedString = gadget.render(emptyBoardString);
    ...
    public void testRenderVerticalSWCorner() {
        RightFlipperGadget gadget = new RightFlipperGadget("test", new Vect(0, 18), VertexOrientation.NW);
        gadget.doAction();
        String renderedString = gadget.render(emptyBoardString);
    ...
    public void testRenderVerticalSECorner() {
        RightFlipperGadget gadget = new RightFlipperGadget("test", new Vect(18, 18), VertexOrientation.NW);
        String renderedString = gadget.render(emptyBoardString);
        gadget.doAction();
        for (int y = 1; y < 21; y++) {
            for (int x = 1; x < 21; x++) {
    ...
    public void testEquals() {
        RightFlipperGadget g1 = new RightFlipperGadget("Bilbo", new Vect(0, 0), VertexOrientation.NW);
        RightFlipperGadget g2 = new RightFlipperGadget("Bilbo", new Vect(0, 0), VertexOrientation.NW);
        RightFlipperGadget g3 = new RightFlipperGadget("Baggins", new Vect(5, 0), VertexOrientation.NW);
