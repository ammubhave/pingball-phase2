...
public class GadgetTests {
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        coord2 = new Vect(1, 1);
        coord3 = new Vect(6, 5);
        coord4 = new Vect(19, 0);
        coord5 = new Vect(19, 19);
        coord6 = new Vect(6, 2);
        coord7 = new Vect(10, 5);
        coord8 = new Vect(6, 10);
        coord9 = new Vect(2, 5);
    ...
    public void circularBumperBounceTest() {
        Ball b = new Ball("b1", coord9, vel1);
        CircularBumper circBump = new CircularBumper(coord3, "CIRCLE");
        circBump.reactBall(b);
        assertTrue(b.getVelocity().x() == -1);
    ...
    public void squareBumperBounceRightTest() {
        Ball b = new Ball("b3", coord7, vel3);
    ...
    public void squareBumperBounceBottomTest() {
        Ball b = new Ball("b1", coord8, vel4);
    ...
    public void triangle0BumperBounceLegHTest() {
        Ball b = new Ball("b1", coord6, vel2);
    ...
    public void triangle0BumperBounceHypotenuseTest() {
        Ball b = new Ball("b1", coord7, vel3);
        TriangularBumper triBump = new TriangularBumper(coord3, "TRIANGLE");
