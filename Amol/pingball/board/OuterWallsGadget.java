 ...
 */
public class OuterWallsGadget implements Gadget {
     ...
     */
    public OuterWallsGadget(Vect position, OuterWallsOrientation orientation, double coefficientOfReflection) {
        this.height = 20;
        this.width = 20;
     ...
     * @param orientation the orientation of the wall
     */
    public OuterWallsGadget(Vect position, OuterWallsOrientation orientation) {
