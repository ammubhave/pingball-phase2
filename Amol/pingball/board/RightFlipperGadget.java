 ...
 */
public class RightFlipperGadget implements Gadget {
    private String name;
     ...
     */
    public RightFlipperGadget(String name, Vect position, VertexOrientation vertexOrientation, double coefficientOfReflection) {
        this.name = name;
     ...
     * @param orientation the orientation of the flipper
     */
    public RightFlipperGadget(String name, Vect position, VertexOrientation vertexOrientation) {
    ...
    public String render(String input) {
        ...
        if (this.vertexOrientation == VertexOrientation.SW && this.orientation == FlipperOrientation.VERTICAL ||
            this.vertexOrientation == VertexOrientation.NE && this.orientation == FlipperOrientation.VERTICAL) {
            sb.setCharAt(Board.getBoardStringIndexFromVect(this.position), '|');
    ...
    public boolean equals(Object obj) {
        if(!(obj instanceof RightFlipperGadget)) return false;
        return ((RightFlipperGadget)obj).name.equals(this.name);
    }
}
